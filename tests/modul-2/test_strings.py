...
def test_string_konkatenation(s1: int | float | str | bool, s2: int | float | str | bool, expected: int | float | str | bool) -> None:
...
def test_string_multiplikation(char: int | float | str | bool, n: int | float | str | bool, expected: int | float | str | bool) -> None:
...
def test_string_laenge(text: int | float | str | bool, expected_length: int | float | str | bool) -> None:
...
def test_string_indexierung(text: int | float | str | bool, index: int | float | str | bool, expected_char: int | float | str | bool) -> None:
...
def test_string_slicing(text: int | float | str | bool, start: int | float | str | bool, end: int | float | str | bool, expected: int | float | str | bool) -> None:
...
def test_string_case_methoden(text: int | float | str | bool, expected_upper: int | float | str | bool, expected_lower: int | float | str | bool) -> None:
...
def test_string_startswith(text: int | float | str | bool, prefix: int | float | str | bool, expected: int | float | str | bool) -> None:
...
def test_string_endswith(text: int | float | str | bool, suffix: int | float | str | bool, expected: int | float | str | bool) -> None:
