...
def test_celsius_zu_fahrenheit(celsius: int | float | str | bool, expected_fahrenheit: int | float | str | bool) -> None:
...
def test_fahrenheit_zu_celsius(fahrenheit: int | float | str | bool, expected_celsius: int | float | str | bool) -> None:
...
def test_celsius_zu_kelvin(celsius: int | float | str | bool, expected_kelvin: int | float | str | bool) -> None:
...
def test_kelvin_zu_celsius(kelvin: int | float | str | bool, expected_celsius: int | float | str | bool) -> None:
